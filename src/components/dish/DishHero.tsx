...
const DishHero = ({ name, tagline, image }: DishHeroProps) => {
  return (
    <section className="relative h-[50vh] min-h-[400px] w-full overflow-hidden flex items-center justify-center">
      ...
      <div className="relative z-10 text-center px-6">
        ...
        >
          ...
          <h1 className="font-display text-5xl md:text-7xl lg:text-8xl font-bold text-white mb-6 tracking-tight drop-shadow-2xl">
            {name}
          </h1>
          <div className="w-24 h-[1px] bg-primary/40 mx-auto mb-6" />
          <p className="font-body text-gray-300 text-lg md:text-xl max-w-2xl mx-auto font-light tracking-wide uppercase">
            {tagline}
          </p>
        </motion.div>
      </div>
