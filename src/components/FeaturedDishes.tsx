...
const dishes = [
  { image: dish1, name: "Paneer Butter Masala", desc: "Rich, creamy tomato-based curry with soft paneer cubes" },
  { image: dish2, name: "Veg Kolhapuri", desc: "Spicy Maharashtrian curry packed with bold flavors" },
  { image: dish3, name: "Misal Pav", desc: "Authentic spicy street-style curry with crunchy farsan" },
];
