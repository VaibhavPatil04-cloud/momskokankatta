    ...
    <div className="container relative z-10 mx-auto text-center">
      ...
      <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8 mb-20">
        {categories.map((c, i) => (
          ...
          >
            {/* Soft Gradient Overlay (Bottom Fade) - reveals on hover */}
            <div className="absolute inset-0 bg-gradient-to-t from-black/90 via-black/40 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-700 pointer-events-none z-10" />

            {/* Default Content (Icon + Title) */}
            <div className="relative z-0 flex flex-col items-center transition-transform duration-700 group-hover:-translate-y-12">
              {/* Icon with glow */}
